            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Détails <b>{{$data->nama}}</b></h4>
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('tgl_lahir') ? ' has-error' : '' }}">
                            <label for="tgl_lahir" class="col-md-4 control-label">Lieu de naissance</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="prodi" required="" disabled="">
                                <option value=""></option>
                                <option value="TI" {{$data->prodi === "TI" ? "selected" : ""}} ></option>
                                <option value="SI" {{$data->prodi === "SI" ? "selected" : ""}} ></option>
                                <option value="KM" {{$data->prodi === "KM" ? "selected" : ""}} ></option>
                            </select>
                            </div>
                        </div>
