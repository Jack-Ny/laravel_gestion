            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Modifier les informations d'un membre</h4>
                        ...
                        <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="jk" required="">
                                <option value=""></option>
                                <option value="L" {{$data->jk === "L" ? "selected" : ""}}>Homme</option>
                                <option value="P" {{$data->jk === "P" ? "selected" : ""}}>Femme</option>
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="prodi" required="">
                                <option value=""></option>
                                <option value="TI" {{$data->prodi === "TI" ? "selected" : ""}} >Ingénierie informatique</option>
                                <option value="SI" {{$data->prodi === "SI" ? "selected" : ""}} >Système d'information</option>
                                <option value="KM" {{$data->prodi === "KM" ? "selected" : ""}} >Santé publique</option>
                            </select>
                            </div>
                        </div>
