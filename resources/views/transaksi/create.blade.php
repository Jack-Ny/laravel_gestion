            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Ajouter un nouvel emprunt</h4>
                        ...
                        <div class="form-group{{ $errors->has('kode_transaksi') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('tgl_pinjam') ? ' has-error' : '' }}">
                            <label for="tgl_pinjam" class="col-md-4 control-label">Date du prêt</label>
                            <div class="col-md-3">
                        ...
                        <div class="form-group{{ $errors->has('buku_id') ? ' has-error' : '' }}">
                            <label for="buku_id" class="col-md-4 control-label">Livres</label>
                            <div class="col-md-6">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-info btn-secondary" data-toggle="modal" data-target="#myModal"><b>Recherche de livres</b> <span class="fa fa-search"></span></button>
                                </span>
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('anggota_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-warning btn-secondary" data-toggle="modal" data-target="#myModal2"><b>Recherche d'abonnés</b> <span class="fa fa-search"></span></button>
                                </span>
                                </div>
