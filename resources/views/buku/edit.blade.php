            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Editer un livre <b>{{$data->judul}}</b> </h4>
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
                            <label for="isbn" class="col-md-4 control-label">Numéro ISBN</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('pengarang') ? ' has-error' : '' }}">
                            <label for="pengarang" class="col-md-4 control-label">Auteur</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('penerbit') ? ' has-error' : '' }}">
                            <label for="penerbit" class="col-md-4 control-label">Editeur</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('tahun_terbit') ? ' has-error' : '' }}">
                            <label for="tahun_terbit" class="col-md-4 control-label">Année de publication</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('jumlah_buku') ? ' has-error' : '' }}">
                            <label for="jumlah_buku" class="col-md-4 control-label">Nombre d'exemplaires</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('lokasi') ? ' has-error' : '' }}">
                            <label for="lokasi" class="col-md-4 control-label">Localisation</label>
                            <div class="col-md-6">
                            <select class="form-control" name="lokasi" required="">
                                <option value="rak1" {{$data->lokasi === "rak1" ? "selected" : ""}}>Etagère 1</option>
                                <option value="rak2" {{$data->lokasi === "rak2" ? "selected" : ""}}>Etagère 2</option>
                                <option value="rak3" {{$data->lokasi === "rak3" ? "selected" : ""}}>Etagère 3</option>
                            </select>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="email" class="col-md-4 control-label">Couverture</label>
                            <div class="col-md-6">
                        ...
                        <a href="{{route('buku.index')}}" class="btn btn-light pull-right">Retour</a>
                    </div>
                  </div>
                </div>
              </div>
