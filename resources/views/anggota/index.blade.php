...
<div class="row">
  ...
  <div class="col-lg-2">
    <a href="{{ route('anggota.create') }}" class="btn btn-primary btn-rounded btn-fw"><i class="fa fa-plus"></i> Ajouter un abonné</a>
  </div>
    <div class="col-lg-12">
                      ...
                      @foreach($datas as $data)
                        <tr>
                          ...
                          <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
                            ...
                            {{ csrf_field() }}
                            {{ method_field('delete') }}
                            <button class="dropdown-item" onclick="return confirm('Êtes-vous sûr de vouloir supprimer les données d\'initialisation?')"> Supprimer
                            </button>
                          </form>
